<template>
  <div>
    ...
    <header>
      <div class="header-left">
        ...
        <div
          class="menu-panel"
          role="dialog"
          aria-labelledby="student-nav-title"
        >
    ...
    <main>
      ...
      <h2>My Teachers</h2>
      <p>
        Evaluate your teachers for this semester. Your feedback helps improve
  ...
  methods: {
    async getTeachers() {
      try {
        ...
        if (result.success)
          this.teachers = result.teachers.map((teacher) => ({ ...teacher }));
    ...
    skipLogin() {
      ...
      if (!token) this.$router.replace("/new-Dashboard");
    },
  },
